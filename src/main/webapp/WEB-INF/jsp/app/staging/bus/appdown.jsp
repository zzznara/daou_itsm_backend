...
<html lang="ko">
	...
	<body>
		...
		<p class="title">KISCO 한국철강(주) 통근버스 앱 다운로드 - Staging</p>
		<div class="glassBox">
			<div class="menu">
				<div>
					<h2>통근버스 - Android</h2>
					<div class="iconDiv">
						<a href="/app/download/bus/staging/app-releaseStaging.apk" type="application/vnd.android.package-archive">
...
<%--						<p>Ver 1.0.0</p>--%>
						<!--qrDiv추가-->
						<div class="qrDiv">
							<img src="/app/download/BUS_STAGING_ANDROID.png">
						</div>
				</div>
			</div>
		</div>
