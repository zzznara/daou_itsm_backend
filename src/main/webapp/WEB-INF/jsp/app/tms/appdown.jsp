...
<html lang="ko">
	...
	<body>
		...
		<p class="title">KISCO 한국철강(주) TMS 앱 다운로드</p>
		<div class="glassBox">
			<div class="menu">
				<div>
					<h2>TMS - Android</h2>
					<div class="iconDiv">
						<a href="/app/download/tms/production/app-release.apk" type="application/vnd.android.package-archive">
					...
					<p class="info">아이콘을 클릭하시면 다운로드가 진행됩니다.</p>
						...
						<!--qrDiv추가-->
						<div class="qrDiv">
							<img src="/app/download/TMS_ANDROID.png">
						</div>
				</div>
			...
			<div class="menu">
				<div>
					...
					<div class="iconDiv" style="border-radius: 16px;">
						<a href="itms-services://?action=download-manifest&amp;url=https://tmsm.kisco.co.kr/app/download/tms/production/manifest.plist">
					...
					<p class="info">아이콘을 클릭하시면 다운로드가 진행됩니다.</p>
						...
						<!--qrDiv추가-->
						<div class="qrDiv">
							<img src="/app/download/TMS_iOS.png">
						</div>
				</div>
