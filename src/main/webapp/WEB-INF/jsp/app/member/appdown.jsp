...
<html lang="ko">
	...
	<body>
		...
		<p class="title">KISCO 한국철강(주) 직원 앱 다운로드</p>
		<div class="glassBox">
			<div class="menu">
				<div>
					<h2>직원 앱 - Android</h2>
					<div class="iconDiv">
						<a href="/app/download/member/production/app-release.apk" type="application/vnd.android.package-archive">
						...
						<!--qrDiv추가-->
						<div class="qrDiv">
							<img src="/app/download/MEMBER_ANDROID.png">
						</div>
				</div>
			</div>
		</div>
			...
			<div class="menu">
				<div>
					...
					<div class="iconDiv" style="border-radius: 16px;">
						<a href="itms-services://?action=download-manifest&amp;url=https://tmsm.kisco.co.kr/app/download/member/production/manifest.plist">
...
<%--						<p>Ver 1.0.0</p>--%>
						<!--qrDiv추가-->
						<div class="qrDiv">
							<img src="/app/download/MEMBER_iOS.png">
				</div>
			</div>
